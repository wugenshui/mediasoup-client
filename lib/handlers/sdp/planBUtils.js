...
function getRtpEncodings(_a) {
    ...
    var offerMediaObject = _a.offerMediaObject, track = _a.track;
...
function addLegacySimulcast(_a) {
    var offerMediaObject = _a.offerMediaObject, track = _a.track, numStreams = _a.numStreams;
    if (numStreams <= 1)
    ...
    var ssrcCnameLine = offerMediaObject.ssrcs
        .find(function (line) { return (line.attribute === 'cname' && line.id === firstSsrc); });
    if (!ssrcCnameLine)
