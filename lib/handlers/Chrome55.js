...
var Chrome55 = /** @class */ (function (_super) {
    __extends(Chrome55, _super);
    function Chrome55() {
     ...
     */
    Chrome55.createFactory = function () {
        return function () { return new Chrome55(); };
    };
    Object.defineProperty(Chrome55.prototype, "name", {
        get: function () {
            return 'Chrome55';
        },
        enumerable: false,
    ...
    Chrome55.prototype.close = function () {
        logger.debug('close()');
    ...
    Chrome55.prototype.getNativeRtpCapabilities = function () {
    ...
    Chrome55.prototype.getNativeSctpCapabilities = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Chrome55.prototype.run = function (_a) {
        var _this = this;
    ...
    Chrome55.prototype.updateIceServers = function (iceServers) {
        return __awaiter(this, void 0, void 0, function () {
            var configuration;
            return __generator(this, function (_a) {
    ...
    Chrome55.prototype.restartIce = function (iceParameters) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Chrome55.prototype.getTransportStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Chrome55.prototype.send = function (_a) {
        var track = _a.track, encodings = _a.encodings, codecOptions = _a.codecOptions, codec = _a.codec;
        return __awaiter(this, void 0, void 0, function () {
            var offer, localSdpObject, offerMediaObject, sendingRtpParameters, sendingRemoteRtpParameters, idx, _b, _c, encoding, answer, localId;
            var e_1, _d;
                ...
                switch (_e.label) {
                    ...
                    case 3:
                        if (track.kind === 'video' && encodings && encodings.length > 1) {
                            ...
                            localSdpObject = sdpTransform.parse(offer.sdp);
                            offerMediaObject = localSdpObject.media.find(function (m) { return m.type === 'video'; });
    ...
    Chrome55.prototype.stopSending = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            var track, offer, error_2, answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this._assertSendDirection();
    ...
    Chrome55.prototype.replaceTrack = function (
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    Chrome55.prototype.setMaxSpatialLayer = function (localId, spatialLayer) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_1.UnsupportedError(' not implemented');
            });
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    Chrome55.prototype.setRtpEncodingParameters = function (localId, params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    Chrome55.prototype.getSenderStats = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_1.UnsupportedError('not implemented');
            });
    ...
    Chrome55.prototype.sendDataChannel = function (_a) {
    ...
    Chrome55.prototype.receive = function (_a) {
        var trackId = _a.trackId, kind = _a.kind, rtpParameters = _a.rtpParameters;
        return __awaiter(this, void 0, void 0, function () {
            var localId, mid, streamId, offer, answer, localSdpObject, answerMediaObject, stream, track;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 5:
                        _b.sent();
                        stream = this._pc.getRemoteStreams()
                            .find(function (s) { return s.id === streamId; });
                        track = stream.getTrackById(localId);
                        if (!track)
                            throw new Error('remote track not found');
                        // Insert into the map.
                        this._mapRecvLocalIdInfo.set(localId, { mid: mid, rtpParameters: rtpParameters });
                        return [2 /*return*/, { localId: localId, track: track }];
                }
            });
        });
    };
    Chrome55.prototype.stopReceiving = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    Chrome55.prototype.getReceiverStats = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_1.UnsupportedError('not implemented');
            });
    ...
    Chrome55.prototype.receiveDataChannel = function (_a) {
    ...
    Chrome55.prototype._setupTransport = function (_a) {
    ...
    Chrome55.prototype._assertSendDirection = function () {
        if (this._direction !== 'send') {
            throw new Error('method can just be called for handlers with "send" direction');
        }
    };
    Chrome55.prototype._assertRecvDirection = function () {
