...
var Firefox60 = /** @class */ (function (_super) {
    ...
    Firefox60.prototype.close = function () {
        logger.debug('close()');
    ...
    Firefox60.prototype.getNativeRtpCapabilities = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pc, canvas, fakeStream, fakeVideoTrack, videoTransceiver, parameters, encodings, offer, sdpObject, nativeRtpCapabilities, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        videoTransceiver = pc.addTransceiver(fakeVideoTrack, { direction: 'sendrecv' });
                        ...
                        return [4 /*yield*/, videoTransceiver.sender.setParameters(parameters)];
                    case 2:
                        _a.sent();
    ...
    Firefox60.prototype.getNativeSctpCapabilities = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Firefox60.prototype.run = function (_a) {
        var _this = this;
        ...
        this._pc = new RTCPeerConnection(__assign({ iceServers: iceServers || [], iceTransportPolicy: iceTransportPolicy || 'all', bundlePolicy: 'max-bundle', rtcpMuxPolicy: 'require' }, additionalSettings), proprietaryConstraints);
    ...
    Firefox60.prototype.updateIceServers = function (iceServers) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Firefox60.prototype.restartIce = function (iceParameters) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Firefox60.prototype.getTransportStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Firefox60.prototype.send = function (_a) {
        var track = _a.track, encodings = _a.encodings, codecOptions = _a.codecOptions, codec = _a.codec;
        return __awaiter(this, void 0, void 0, function () {
            var sendingRtpParameters, sendingRemoteRtpParameters, transceiver, parameters, offer, localSdpObject, localId, offerMediaObject, newEncodings, _b, _c, encoding, answer;
            var e_1, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        transceiver = this._pc.addTransceiver(track, { direction: 'sendonly', streams: [this._sendStream] });
                        if (!encodings) return [3 /*break*/, 2];
                    ...
                    case 1:
                        _e.sent();
                        _e.label = 2;
                    case 2: return [4 /*yield*/, this._pc.createOffer()];
                    case 3:
                        offer = _e.sent();
                        localSdpObject = sdpTransform.parse(offer.sdp);
                        if (!!this._transportReady) return [3 /*break*/, 5];
    ...
    Firefox60.prototype.stopSending = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Firefox60.prototype.replaceTrack = function (localId, track) {
        return __awaiter(this, void 0, void 0, function () {
            var transceiver;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Firefox60.prototype.setMaxSpatialLayer = function (localId, spatialLayer) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Firefox60.prototype.setRtpEncodingParameters = function (localId, params) {
        return __awaiter(this, void 0, void 0, function () {
            var transceiver, parameters;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Firefox60.prototype.getSenderStats = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            var transceiver;
            return __generator(this, function (_a) {
                this._assertSendDirection();
    ...
    Firefox60.prototype.sendDataChannel = function (_a) {
    ...
    Firefox60.prototype.receive = function (_a) {
    ...
    Firefox60.prototype.stopReceiving = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            var transceiver, offer, answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Firefox60.prototype.getReceiverStats = function (localId) {
        return __awaiter(this, void 0, void 0, function () {
            var transceiver;
            return __generator(this, function (_a) {
                this._assertRecvDirection();
    ...
    Firefox60.prototype.receiveDataChannel = function (_a) {
    ...
    Firefox60.prototype._setupTransport = function (_a) {
    ...
    Firefox60.prototype._assertSendDirection = function () {
        if (this._direction !== 'send') {
            throw new Error('method can just be called for handlers with "send" direction');
        }
    };
    Firefox60.prototype._assertRecvDirection = function () {
